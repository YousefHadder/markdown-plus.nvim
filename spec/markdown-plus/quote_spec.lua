...
describe("markdown-plus quote", function()
  ...
  describe("toggle_quote_line", function()
    it("toggles quote on the line at cursor position", function()
      vim.api.nvim_buf_set_lines(0, 0, -1, false, { "First line", "Second line", "Third line" })
      vim.api.nvim_win_set_cursor(0, { 2, 0 })
      quote.toggle_quote_line()
      local lines = vim.api.nvim_buf_get_lines(0, 0, -1, false)
      assert.are.equal("First line", lines[1])
      assert.are.equal("> Second line", lines[2])
      assert.are.equal("Third line", lines[3])
  ...
  describe("toggle_quote single line visual", function()
    it("toggles quote on a single-line visual selection", function()
      vim.api.nvim_buf_set_lines(0, 0, -1, false, { "First line", "Second line", "Third line" })
      vim.fn.setpos("'<", { 0, 2, 1, 0 })
      vim.fn.setpos("'>", { 0, 2, 1, 0 })
      quote.toggle_quote()
