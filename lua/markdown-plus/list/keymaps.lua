  ...
  keymap_helper.setup_keymaps(config, {
    {
      ...
      fn = handlers.skip_in_codeblock(handlers.handle_enter, "<CR>", "i"),
      modes = "i",
      default_key = "<CR>",
    ...
    },
    {
      ...
      fn = handlers.skip_in_codeblock(handlers.continue_list_content, "<A-CR>", "i"),
      modes = "i",
      default_key = "<A-CR>",
    ...
    },
    {
      ...
      fn = handlers.skip_in_codeblock(handlers.handle_tab, "<Tab>", "i"),
      modes = "i",
      default_key = "<Tab>",
    ...
    },
    {
      ...
      fn = handlers.skip_in_codeblock(handlers.handle_shift_tab, "<S-Tab>", "i"),
      modes = "i",
      default_key = "<S-Tab>",
    ...
    },
    {
      ...
      fn = handlers.skip_in_codeblock(handlers.handle_backspace, "<BS>", "i"),
      modes = "i",
      default_key = "<BS>",
    ...
    },
    {
      ...
      fn = handlers.skip_in_codeblock(handlers.handle_normal_o, "o", "n"),
      modes = "n",
      default_key = "o",
