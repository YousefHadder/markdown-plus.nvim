...
* **table:** land cursor at start of empty cells when navigating ([#398](https://github.com/YousefHadder/markdown-plus.nvim/issues/398)) ([c6d727b](https://github.com/YousefHadder/markdown-plus.nvim/commit/c6d727bae6cf0cb4c716ef3604164cba32417a15))
...
- Require explicit `require("markdown-plus").setup(opts)` configuration (deprecated auto-setup path removed).
- Default keymap leader namespace migrates from `<Leader>` to `<LocalLeader>`.
