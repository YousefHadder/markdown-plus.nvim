...
When the title fetch fails or times out, you will be prompted to enter a title manually. If you cancel the prompt, the URL is inserted as a plain link using the URL itself as the link text.
